...
title('Problem 2.2: Zero State Response');
xlabel('Time (s)');
...
title('Problem 2.2: Zero Input Response');
xlabel('Time (s)');
ylabel('Response (units)');
...
plot(t, exp(-0.2*t).*(C_1*cos(1.990*t)+C_2*sin(1.990*t))+13.10*cos(t)...
     +1.747*sin(t), 'LineWidth', 2);
title('Problem 2.2: Total Response');
xlabel('Time (s)');
ylabel('Response (units)');
...
plot(t, exp(-0.2*t).*(C_1*cos(1.990*t)+C_2*sin(1.990*t))+13.10*cos(t)...
     +1.747*sin(t), 'LineWidth', 2);
title('Problem 2.3: Zero State Response');
xlabel('Time (s)');
ylabel('Response (units)');
...
subplot(3, 1, 2);                       % 3 rows, one column, second graph
plot(t, exp(-0.2*t).*(C_1*cos(1.990*t)+C_2*sin(1.990*t)), 'LineWidth', 2);
title('Problem 2.3: Zero Input Response');
xlabel('Time (s)');
ylabel('Response (units)');
...
plot(t, exp(-0.2*t).*(C_1*cos(1.990*t)+C_2*sin(1.990*t))+13.10*cos(t)...
     +1.747*sin(t), 'LineWidth', 2);
title('Problem 2.3: Total Response');
xlabel('Time (s)');
ylabel('Response (units)');